  ...
  <div class="panel panel-info">
    ...
    <div class="panel-body">
      <table class="table table-hover">
          <tbody>
							<?php $query = $connection->query("SELECT t.id_transaksi, m.nama_motor, t.lama, t.jaminan, t.total_harga, t.tgl_sewa, t.tgl_ambil, t.tgl_kembali, t.jatuh_tempo, t.status, t.konfirmasi, t.pembatalan FROM transaksi t JOIN pelanggan p USING(id_pelanggan) JOIN motor m ON t.id_motor=m.id_motor WHERE id_transaksi=$_GET[id]");?>
