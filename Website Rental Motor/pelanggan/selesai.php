...
$connection->query("INSERT INTO transaksi VALUES (NULL, $id, $_POST[id_motor], '$now', '$tgl_ambil', NULL, $_POST[lama], $totalbayar, '0', '$_POST[jaminan]', NULL, '$jatuhtempo', '0', '0')");
...
<div class="panel panel-info">
    ...
    <div class="panel-body">
        ...
        <p>
            ...
            <strong>(0986-01-025805-53-8 a/n SEWA MOTOR)</strong> untuk menyelesaikan pembayaran. dan untuk uang muka minimal setengah dari harga sewa.
        </p>
        <p>
